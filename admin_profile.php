...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($updateProfile) {
        ...
        if ($stmt->execute()) {
            echo "<script>alert('Profile updated successfully.');window.location.href = 'admin_index.php';</script>";
        } else {
...
if ($updatePassword) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Password updated successfully.');window.location.href = 'admin_index.php';</script>";
    } else {
...
<body>
    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <button type="button" class="btn btn-secondary" onclick="window.location.href='admin_index.php';">Back to home</button>
