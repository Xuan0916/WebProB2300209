        ...
        <div class="fea-des" data-aos="fade-up">
            <div class="fea-icon">
                <i class="fas fa-laptop"></i>
                    ...
                    <a href="calculate.php"><h2>Survey Form</h2></a>
        ...
        <div class="fea-des" data-aos="fade-up">
            <div class="fea-icon">
                <i class="fas fa-graduation-cap"></i>
                    ...
                    <a href="record.php"><h2>Tracking History</h2></a>
                
                <p>Track your history record.</p>
            </div>
        </div>
        <div class="fea-des" data-aos="fade-up">
            <div class="fea-icon">
                <i class="fas fa-sticky-note"></i>
                    ...
                    <a href="education.php"><h2>Article</h2></a>
                <p>Learn about the importance of tracking carbon footprint.</p>
            </div>
        </div>
        <div class="fea-des" data-aos="fade-up">
            <div class="fea-icon">
                <i class="fas fa-calendar"></i>
                    ...
                    <a href="event.php"><h2>Event calendar</h2></a>
