  ...
  <div class="index-container" id="H1">
    <div class="text-container">
      <div class="index-text">
        <h1 data-aos="fade-up"><strong>hello world!</strong></h1>
        <center>
          <hr data-aos="fade-up">
          ...
          <a href="login.php"><button class="start">Login</button></a>
          &nbsp;
          <a href="register.php"><button class="start">Signup</button></a>
        </center>
      </div>
